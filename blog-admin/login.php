            ...
            <div class="col-lg-4 mx-auto">
              <div class="auto-form-wrapper">
                ...
                <div class="alert alert-danger d-none" id="error-msg" role="alert">
                  ...
                  <div class="form-group">
                    <button type="button" id="submit-login" class="btn btn-primary submit-btn btn-block">Login</button>
                  </div>
                  <div class="form-group d-flex justify-content-end">
                    <a href="<?php common::SITE_URL; ?>forgotpassword.php" class="text-small forgot-password text-black">Forgot Password</a>
                  </div>
                </form>
              </div>
